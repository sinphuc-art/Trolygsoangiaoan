...
<div class="main-header">
    ...
    <p>Tác giả: Xin Văn Phúc - Trường PTDTBT Tiểu học Cốc Rế - ĐT: 0399 609 612</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Xin Văn Phúc - Trường PTDTBT Tiểu học Cốc Rế - ĐT: 0399 609 612</div>", unsafe_allow_html=True)
